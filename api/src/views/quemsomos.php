...
<main class="root">
    <div class="cu" style="background-color: var(--MainColor);">
    <h1 style="color: var(--MainColor);">CUZAO</h1>
</div>
...
<div class="container">
  <footer class="py-3 my-4">
    <ul class="nav justify-content-center border-bottom pb-3 mb-3">
      ...
      <li class="nav-item"><a href="sobre.php" class="nav-link px-2 text-body-secondary">Seja alguma coisa</a></li>
    </ul>
    <p class="text-center text-body-secondary">&copy; 2023 Bom Vizinho Project. All Rights Reserved</p>
  </footer>
</div>
