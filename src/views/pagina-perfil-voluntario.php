            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <form>
                        ...
                        <div class="main__servicos__card esconder " id="exclusao-card" style="
    position: relative;
    margin: 5px;">
                            <div class="card__text">
                                <h4>Usuário</h4>
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control item" id="destino-form-criar" placeholder="Destino">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control item" id="ordem-descricao-form-criar" placeholder="Descrição">
                        </div>
                       [<div class="form-group">
                    ...
                    <div id="validationMessage" style="color: red;"></div>
                        ...
                        <div class="card__form_serv esconder" id="registration-form-mostrar" style="padding: 50px;">
                            <form>
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control item" id="destino-form-mostrar" placeholder="Destino" readonly>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control item" id="ordem-descricao-form-mostrar" placeholder="Descrição" readonly>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control item" id="status-ordem-form-mostrar" placeholder="Status" readonly>
                                </div>
                            </form>
                            <div id="validationMessage" style="color: red;"></div>
                        </div>
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control item" id="destino-form-editar" placeholder="Destino" required oninvalid="this.setCustomValidity('Por favor, preencha este campo.')">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control item" id="ordem-descricao-form-editar" placeholder="Descrição" required oninvalid="this.setCustomValidity('Por favor, preencha este campo.')">
                        </div>
                        <div class="form-group">
                            <label for="serviceSelect-form">Selecione o Serviço:</label>
                            <select id="serviceSelect-form" class="form-control" style="background-color:#fdf5eb;">
