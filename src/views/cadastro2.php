...
<body>
  ...
  <div class="container">
    ...
    <form id="formidoso">
      ...
      <!-- TODO: implementar novos campos para cadastro -->
      <!-- <div class="form-group">
    ...
    <form id="formvol">
      ...
      <div class="form-group">
        <label for="dispo-i">Disponibilidade de horários</label>
        <select class="select" for="dispo-v" id="dispo-v" name="Escolha um período">
          <option value="periodo">Escolha um período</option>
          <option value="manha">Manhã</option>
          <option value="tarde">Tarde</option>
          <option value="noite">Noite</option>
      ...
      <label for="password-v">Senha</label>
      <input type="password" id="password-v" placeholder="Digite sua senha." />
      <i class="fas fa-exclamation-circle"></i>
      <i class="fas fa-check-circle"></i>
      <span class="esconder"><small>Mensagem de erro</small></span>

      <label for="password-confirmation-v">Confirmação de senha</label>
      <input type="password" id="password-confirmation-v" placeholder="Digite sua senha novamente." />
      <i class="fas fa-exclamation-circle"></i>
      <i class="fas fa-check-circle"></i>
      <span class="esconder"><small>Mensagem de erro</small></span>
